...
return  array(
    ...
    'TMPL_ACTION_ERROR'     => './Application/Tpl/default/dispatch_jump.html',//THINK_PATH.'Tpl/dispatch_jump.tpl', // 默认错误跳转对应的模板文件
    'TMPL_ACTION_SUCCESS'   => './Application/Tpl/default/dispatch_jump.html',//THINK_PATH.'Tpl/dispatch_jump.tpl', // 默认成功跳转对应的模板文件
    'TMPL_EXCEPTION_FILE'   => THINK_PATH.'Tpl/think_exception.tpl',//'./Public/404.html',//THINK_PATH.'Tpl/think_exception.tpl',// 异常页面的模板文件
