				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">公告动态列表</h1>
									<span class="mainDescription"></span>
									<h3>公告动态</h3>
								</div>
								<nav id="cl-effect-10" class="links cl-effect-10">
									<a data-hover="新增" href="<?php echo U('admin/system/sys_notice_edit');?>"><span>新增</span></a>
								</nav>
								<!-- <ol class="breadcrumb">
									<li>
										<span>Pages</span>
	...
	<form role="form" class="form-inline">	
		<div class="panel-body">
				...
				<div class="form-group">
					  ...
					  公告动态标题
						<input type="text" name="title" value="<?php echo ($_GET["title"]); ?>" id="title" placeholder="公告动态标题" class="form-control">
		...
		<select class="form-control" id="type" name="type">
			...
			<option value="1"  <?php if($_GET["type"] == 1): ?>selected<?php endif; ?>>公告</option>
			<option value="2"  <?php if($_GET["type"] == 2): ?>selected<?php endif; ?>>动态</option>
...
<table class="table table-hover" id="sample-table-1">
      ...
      <?php if(is_array($list['list'])): $key = 0; $__LIST__ = $list['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr>
						<td ></td>
						<td ><?php echo (mbubstr_html($vo["title"],0,18)); ?></td>
						<td class="hidden-xs"><?php echo (mbubstr_html($vo["content"],0,36)); ?></td>
						<td> <?php echo (date("Y-m-d",$vo["add_time"])); ?></td>
						<td>
						 <?php echo ($vo['type']==1?"公告":"动态"); ?>
						</td>
						<td>
						...
						<div class="visible-md visible-lg hidden-sm hidden-xs">
							     <a href="<?php echo U("Admin/System/sys_notice_edit",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs"  tooltip="Edit"  tooltip-placement="top" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>

							   <a href="<?php echo U("Admin/System/sys_notice_del",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs tooltips"  tooltip-placement="top" data-toggle="tooltip" data-original-title="删除" onclick="return confirm('确定删除该数据？')"><i class="fa fa-times fa fa-white"></i></a> 
