				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">管理员分组</h1>
									<span class="mainDescription"></span>
								</div>
								<nav id="cl-effect-10" class="links cl-effect-10">
									<a data-hover="新增" href="<?php echo U('admin/system/group_edit');?>"><span>新增</span></a>
								</nav>
								<!-- <ol class="breadcrumb">
									<li>
										<span>Pages</span>
...
<table class="table table-hover" id="sample-table-1">
      ...
      <?php if(is_array($list)): $key = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr>
						...
						<td class="hidden-xs"><?php echo ($vo["title"]); ?></td>
						
						<td>
						<?php echo ($vo['auid']?'商家分组':'系统分组'); ?>	
						</td>
						<td>
						<?php echo ($vo['status']?'有效':'无效'); ?>	
						</td>
						<td class="center">
						<div class="visible-md visible-lg hidden-sm hidden-xs">
							<a href="<?php echo U("Admin/System/group_edit",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs" tooltip-placement="top" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
							
							<!-- <a href="###" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove" onclick="return confirm('确定删除该数据？')"><i class="fa fa-times fa fa-white"></i></a> -->
						</div>
						</td>
